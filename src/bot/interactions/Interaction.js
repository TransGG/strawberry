...
class Interaction {
    ...
    /**
     * Returns data that describe the format of the interaction in some way. Subclasses should
     * implement getData() and if they don't, this function will run and throw an error
